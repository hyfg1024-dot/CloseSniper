...
osascript -e 'display dialog "CloseSniper后台任务已安装：工作日14:30、14:45静默采样，14:52生成严格标准和理性流程两套结果；09:45和10:30自动校验。Mac需保持开机且未休眠。" buttons {"好"} default button "好" with icon note'
